...
- [KServe로 모델 외부 포인트에 노출](/7.kserve/tutorial.md)
...
*참고*
- [mlflow 엔드포인트 생성](https://kserve.github.io/website/0.7/modelserving/storage/s3/s3/#attach-secret-to-a-service-account)
